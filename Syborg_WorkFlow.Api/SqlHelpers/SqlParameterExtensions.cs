...
namespace SqlHelpers
{
    ...
    public static class SqlParameterExtensions
    {
        ...
        //{
        //    return Factory.CreateParameter(theValue, parameterName, direction);
        //    // Solution: Use UniqueIdentifier type command.Parameters.Add("@RoleId", SqlDbType.UniqueIdentifier).Value = guidValue; // ✅
        //}

        public static SqlParameter CreateSqlParameter(this Guid theValue, string parameterName, ParameterDirection direction = ParameterDirection.Input)
        {
        ...
        public static SqlParameter CreateSqlParameter(this Guid? theValue, string parameterName, ParameterDirection direction = ParameterDirection.Input)
        {
            ...
            {
                Value = theValue ?? (object)DBNull.Value,
                Direction = direction
            };
        }
